      ...
      <q-page class="bg-white">
        <div class="row dashboard-section">
          <div class="col">
            <center>
              <img
                src="~/assets/images/components/silver_badge.png"
                width="50"
                v-if="user.role.id === 8"
              />
              <img
                src="~/assets/images/components/gold_badge.png"
                width="50"
                v-else-if="user.role.id === 9"
              />
              <img
                src="https://image.flaticon.com/icons/svg/590/590470.svg"
                width="50"
                v-else-if="user.role.id === 10"
              />
              <h6
                style="font-size: 16px; font-family: 'Open Sans'; font-weight: bold; margin: 0"
              >{{ user.name }}</h6>
              ...
              <div class="col">
                <q-list bordered>
                  <q-item dense clickable v-ripple>
                    ...
                    <q-item-section>
                      <span style="font-size: 12px; color: black; line-height: 15px">
                        Promo & Voucher Saya
                        <span
                  ...
                  <q-item dense clickable v-ripple to="/resetPassword">
                    ...
                    <q-item-section>
                      <span style="font-size: 12px; color: black; line-height: 15px">Reset Password</span>
                    </q-item-section>
                  ...
                  <q-item dense clickable v-ripple to="/updatePassword">
                    ...
                    <q-item-section>
                      <span style="font-size: 12px; color: black; line-height: 15px">Ganti Password</span>
                    </q-item-section>
