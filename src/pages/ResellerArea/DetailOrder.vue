  ...
  <q-layout view="hHh lpR fFf">
    <q-header class="mobile-layout-on-desktop">
      <q-toolbar class="bg-distrodakwah text-white">
        ...
        <q-toolbar-title>
          <span style="font-size: 16px; font-weight: bold">Invoice {{ dataOrder.invoice }}</span>
        </q-toolbar-title>
      </q-toolbar>
    </q-header>
          ...
          <div style="background-color: white;; padding: 13px 0 10px 0">
            <div class="row q-px-lg">
              <div class="col">
                ...
                >Tgl Order : {{ dataOrder.created_at ? new Date(dataOrder.created_at).toLocaleDateString('id-ID', { year: 'numeric', month: 'numeric', day: 'numeric' }) : '' }}</h5>
              </div>
