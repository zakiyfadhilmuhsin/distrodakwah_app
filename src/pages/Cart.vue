            ...
            <div class="bg-grey-3" style="height: 100%">
               ...
               >
                  ...
                  >
                     <div class="col">
                        <img
                           src="~/assets/images/components/peti.png"
                           width="130"
                        />
                     </div>
                     <div class="col">
         ...
         if (
            ...
            try {
               productSkuRes = await this.$axios({
                  ...
                  headers: getHeader(),
                  data: {
                     productSkuIdArr: tempCart.cart_detail.map(
                        (e) => e.product_sku_id
                     ),
                     select: [
                        'id',
               ...
               console.log('error fetching product skus');
            }

            tempProductSkuArr = productSkuRes.data.data;
            console.log(tempProductSkuArr, 'aaaaaa');
            ...
            tempCart.cart_detail.forEach((cart_detail, index) => {
               ...
               tempCart.cart_detail[
                  index
               ].product_name = findProductSku.product_parent
                  ? findProductSku.product_parent.product_name
                  : 'produk tidak ada';

               tempCart.cart_detail[
                  index
               ].featured_image = findProductSku.product_parent
               ...
               tempCart.cart_detail[index].stock_sufficient =
                  ...
                  cart_detail.qty || !findProductSku.product_parent
                     ? false
                     : true;
            });
