              ...
              <div class="col">
                ...
                <div class="shadow-5 bg-white q-pa-lg" style="border-radius: 8px; margin-top: 30px">
                  ...
                  <div class="row q-py-xs">
                    <div class="col-6">
                      <q-checkbox dense v-model="rememberMe" val="true" color="orange-8" size="sm" />
                      <span
                  ...
                  <q-btn @click="submitLogin" flat class="bg-amber-8 full-width">
                    <span class="text-white text-capitalize" style="font-weight: bolder; font-family: 'Open Sans'">Masuk</span>
                  </q-btn>
                  <hr style="border-bottom: 1px solid #F8F8F8; margin: 15px 0" />
                  <p class="login-small-text text-center text-bold">
                    Belum Punya Akun?
                  </p>
                  <q-btn to="/activation" flat class="bg-amber-8 full-width">
                    <span class="text-white text-capitalize" style="font-weight: bolder; font-family: 'Open Sans'">Buat Akun</span>
                  </q-btn>
                </div>
              </div>
            </div>
...
.bg-layer-1-login {
  ...
  background: linear-gradient(180deg, rgba(254,165,0,1) 0%, rgba(254,191,0,1) 100%, rgba(255,255,255,1) 100%);
}
</style>