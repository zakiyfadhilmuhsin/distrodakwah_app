<template>
  <q-layout view="hHh lpR fFf">
    <q-header reveal class="mobile-layout-on-desktop transparent no-shadow">
      <q-toolbar>
        <q-btn flat round dense to="/" style="background-color: rgba(0, 0, 0, 0.15)">
    ...
    >
      <q-toolbar class="bg-white text-black">
        ...
        <q-space />
        <q-btn flat class="bg-orange-8 text-white" @click="addToCart">Beli Sekarang</q-btn>
      </q-toolbar>
    </q-footer>
          ...
          <div class="col">
            ...
            >
              ...
              <div class="row">
                ...
                <div class="col-xs-6" v-if="globalState.userProfile.role.id === 9">
                  <h5
                ...
                <div class="col-xs-6" v-else-if="globalState.userProfile.role.id === 8">
                  <h5
                    class="price-detail-text text-green"
                    v-if="productVariant"
                ...
                <div class="col-xs-6" v-else-if="globalState.userProfile.role.id === 10">
                  <h5
                    class="price-detail-text text-green"
                    v-if="productVariant"
            ...
            <div class="row" v-if="globalState.userProfile.role.id === 8 && productVariant">
              <div class="col">
      ...
      <q-dialog v-model="confirmOrder">
        <q-card style="width: 800px; max-width: 90vw;">
          ...
          <q-card-section>
            ...
            <div class="row">
              <div class="col">
                <q-btn to="/cart" flat class="bg-orange-8 text-white full-width">
                  <b>Cek Keranjang</b>
                </q-btn>
