          ...
          <div style="background-color: white;; padding: 13px 0 10px 0">
            ...
            <div class="row q-px-lg items-center" style="padding-top: 15px; padding-bottom: 15px">
              <div class="col-xs-8">
                ...
                <h6 style="font-size: 12px; margin: 0; font-family: 'Open Sans'; line-height: 18px" v-if="dataOrder.voucher_id !== null">Potongan Harga</h6>
              ...
              <div class="col-xs-4 text-right">
                ...
                <h6 style="margin: 0; font-size: 12px; line-height: 18px" class="text-red" v-if="dataOrder.voucher_id !== null">-Rp{{ formatPrice( (dataOrder.total_amount + dataOrder.shipment_fee) * dataOrder.voucher_discount / 100) }}</h6>
        ...
        axios.post( paymentConfirmationUrl, paymentConfirm, { headers: getHeader() } )
          .then(response => {
            ...
            if (response.status === 200) {
              ...
              openURL("https://wa.me/6287821550989?text=Konfirmasi%20Pembayaran%0A%0ABank%20Penerima:%20" + this.bankReceiver + "%0ABank%20Pengirim:%20" + this.bankSender + "%0ANo%20Invoice:%20" + this.dataOrder.invoice + "%0ANama%20Pengirim:%20" + this.senderName + "%0ATotal%20Transfer:%20" + this.totalTransfer + "%0ATanggal%20Transfer:%20" + this.transferDate + "%0A%0A*Jangan%20Lupa%20Kirim%20Bukti%20Pembayaran*");
