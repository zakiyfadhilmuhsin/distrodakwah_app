                  ...
                  <div class="row q-px-lg">
                     ...
                     <div class="col text-right">
                        ...
                        >
                           Rp{{
                              formatPrice(
                                 dataOrder.grand_total + dataOrder.code_unique
                              )
                           }}
                        </h5>
                     </div>
                     ...
                     <div class="col">
                        ...
                        <h6
                           style="
									...
									"
                        >
                           Silahkan lakukan pembayaran melalui transfer bank ke
                           salah satu rekening dibawah ini sebelum :
                        </h6>
                        <h6
                        ...
                        <h6
                           style="
									...
									"
                        >
                           Pembayaran di luar jam kerja (08:00 - 15:00) insya
                           Allah akan diproses keesokan harinya.
                        </h6>
                     </div>
                  </div>
               </div>
                                 ...
                                 <div class="tab">
                                    ...
                                    <div class="tab-content">
                                       <q-list>
                                          <q-item
                                             v-for="(bank,
                                             index) in dataBank.filter(
                                                (bank) =>
                                                   bank.account_category == 1
                                             )"
                                             :key="index"
                                          >
                                             <q-item-section side>
               ...
               if (response.status === 200) {
                  this.dataBank = response.data.data.map((bank) => {
                     if (bank.account_category == 2)
                        bank.bank_name_tmp =
                           bank.bank_name + '~Virtual Account';
