                        ...
                        <q-list dense>
                           <q-item>
                              ...
                              <q-item-section side>
                                 ...
                                 >
                                    Rp{{
                                       formatPrice($attrs.shipment.shippingCost)
                                    }}
                                 </h6>
                              </q-item-section>
                           </q-item>
               ...
               <div style="background-color: white;; padding: 13px 0 10px 0">
                  ...
                  <div class="row q-px-lg">
                     <div class="col">
                        ...
                        >
                           Jika kamu sudah yakin dengan pesanan ini silahkan
                           tekan tombol
      ...
      async checkout() {
         ...
         if (this.allowOrder) {
            ...
            if (this.$attrs.shipment.shipAsDropshipper) {
               postOrder.set(
                  'customer_name',
                  this.$attrs.shipment.dropshipperName
               );
               postOrder.set(
                  'customer_phone',
            ...
            if (this.$attrs.shipment.type === 'resiOtomatis') {
               ...
               postOrder.set(
                  'service_name',
                  this.$attrs.shipment.serviceSelected
               );
            }
