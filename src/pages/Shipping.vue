  ...
  <q-layout view="hHh lpR fFf">
    <q-header class="mobile-layout-on-desktop">
      <q-toolbar class="bg-distrodakwah text-white">
        ...
        <q-toolbar-title>
          <span style="font-size: 16px; font-weight: bold">Alamat Pengiriman</span>
        </q-toolbar-title>
      </q-toolbar>
    </q-header>
              ...
              <div class="column justify-start">
                <div class="col">
                  ...
                  <center>
                    ...
                    <span style="font-size: 10px; margin: 0; padding: 0 10px">atau</span>
                    <q-btn
                      outline
                      size="sm"
                      color="black"
          ...
          <div style="background-color: white; margin-bottom: 5px">
            <div class="row q-pa-lg items-center">
              <div class="col">
                ...
                >Pesanan kamu akan dikirim ke alamat :</h6>
                <template v-if="dataCustomerSelected !== null">
                  <h6
                    ...
                    class="text-blue-10"
                  >{{ dataCustomerSelected.customer_name }} - {{ dataCustomerSelected.customer_phone }}</h6>
                  <h6
                    style="font-size: 12px; margin: 0; font-family: 'Open Sans'; line-height: 18px"
                  >{{ dataCustomerSelected.address_detail }}, Kecamatan {{ dataCustomerSelected.subdistrict.subdistrict }}, {{ dataCustomerSelected.city.type + ' ' + dataCustomerSelected.city.city }}, Provinsi {{ dataCustomerSelected.province.province }}, {{ dataCustomerSelected.postal_code }}</h6>
                </template>
              ...
              <div class="row q-pa-xs items-center" style="padding-top: 20px; padding-bottom: 20px">
                <div class="col">
                  <template v-if="resiOtomatis !== true">
                    ...
                    <h6
                      style="font-size: 14px; margin: 0; padding: 0 20px 10px 20px; font-family: 'Open Sans'; line-height: 18px; font-weight: bold"
                      v-if="shipment.courierSelected !== '' && dataCustomerSelected !== null"
                    >Pilih tarif :</h6>
                    <q-list dense>
                      <q-item v-for="(cost, index) in dataCost" :key="index">
                        ...
                        <q-item-section>
                          ...
                          <span style="font-size: 10px">
                            ...
                            <span
                              v-if="cost.cost[0].etd !== ''"
                            >{{ '(Estimasi ' + cost.cost[0].etd + ' Hari)' }}</span>
                          </span>
                        </q-item-section>
                      </q-item>
                    </q-list>
...
export default {
  ...
  methods: {
    ...
    getCustomers() {
      axios
        .get(getCustomerUrl + "/" + this.user.id, { headers: getHeader() })
        .then(response => {
          if (response.status === 200) {
